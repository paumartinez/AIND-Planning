...
class PlanningGraph():
    ...
    def add_action_level(self, level):
        ...
        self.a_levels.append(set()) # Set of action nodes
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        n1_add = set(node_a1.action.effect_add)
        n1_rem = set(node_a1.action.effect_rem)
        n2_add = set(node_a2.action.effect_add)
        n2_rem = set(node_a2.action.effect_rem)
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        n1_prepos = set(node_a1.action.precond_pos)
        n1_preneg = set(node_a1.action.precond_neg)
        n2_prepos = set(node_a2.action.precond_pos)
        n2_preneg = set(node_a2.action.precond_neg)
       
        if (n1_add & n2_preneg) | (n1_rem & n2_prepos) | (n2_add & n1_preneg) | (n2_rem & n1_prepos):
            return True
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        for parents_a1 in node_a1.parents:
            for parents_a2 in node_a2.parents:
                if parents_a1.is_mutex(parents_a2):
                    return True
    ...
    def negation_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s) -> bool:
        ...
        # Mutual exclusion: Nodes with the same symbol but different is_pos attributes
